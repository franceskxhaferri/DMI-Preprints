    ...
    <center>
        ...
        <div class="boxContainer" style="width:80%;">
            ...
            <form name="f1" action="modp.php" method="POST" onsubmit="loading(load);"><br/>
                <input style="width:80px; color:red;" type="submit" name="b1" value="Logout" id="botton_logout" class="button" onclick="return confirmLogout()">
                ...
                <a style="color:#ffffff;" href="./users_list.php" id="bottone_keyword" class="buttonlink" onclick="loading(load);">Users</a>
            </form>
            <?php
        ...
        <br/>
        <div class="boxContainer" align="center" style="width:80%;">
            <form name="f3" action="modp.php" method="POST" enctype="multipart/form-data" onsubmit="loading(load);">
                ...
                <br/>
                <br/>
                <input type="submit" name="b3" value="Insert" style="width:70px;" class='button' onclick="return confirmInsert()">
            </form>
        </div>
    </center>
    <?php

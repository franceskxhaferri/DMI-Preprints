    ...
    <body>
        ...
        <form name="f4" action="view_preprints.php" method="GET">
            ...
            <div id="adv" hidden><br/>
                <div style="height:30px;" ><h1>Advanced search options click <a href="#" style='color:#007897;' onclick='window.open(this.href);
                        return false'>here</a> for help</h1></div>
                <div style="height:30px;">Years: 

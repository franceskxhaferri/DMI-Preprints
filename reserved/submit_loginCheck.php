...
if (!$ldapoff) {
	if (InternalAuth($inputUID, $inputPass)) {
		...
		<a href='./recovery_account.php' style='color:#1976D2;'>here</a>, or wait 10 seconds to try again.";
	...
	//if (true){
		...
		echo 'Incorrect credentials!<br/>If you forgot the password click <a href="./recovery_account.php" style="color:#1976D2;">here</a>, or wait 10 seconds to try again.<META HTTP-EQUIV="REFRESH" CONTENT="10; URL=./reserved.php">';
	}
}
} else {
